...
# exercise oscar nominated directors
# create dictionary with the count of Oscar nominations for each director
...
nom_count_dict = {}
for year, nominates_list in nominated.items():
    for nominate in nominates_list:
        if nominate not in nom_count_dict:  #
            nom_count_dict[nominate] = 1    #
        else:                               #
            nom_count_dict[nominate] += 1   # nom_count_dict[nominate] = nom_count_dict.get(nominate, 0) + 1

print("nom_count_dict = {}\n".format(nom_count_dict))

# create dictionary with the count of Oscar wins for each director
